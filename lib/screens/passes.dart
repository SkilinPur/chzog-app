          ...
          child: card(
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(children: [
                ...
                OutlinedButton(
                  style: OutlinedButton.styleFrom(foregroundColor: kAccent2, side: BorderSide(color: kAccent2), shape: RoundedRectangleBorder(), padding: EdgeInsets.symmetric(horizontal: 14, vertical: 16)),
                  onPressed: _checkinQr,
                  child: const Text('QR', style: TextStyle(fontFamily: 'monospace', fontWeight: FontWeight.bold)),
                ),
                const SizedBox(width: 8),
                FilledButton(
                  style: FilledButton.styleFrom(backgroundColor: kAccent, foregroundColor: kBg, shape: RoundedRectangleBorder(), padding: EdgeInsets.symmetric(horizontal: 18, vertical: 16)),
              ...
              if (_msg != null) Padding(padding: EdgeInsets.only(top: 8), child: Text(_msg!, style: TextStyle(color: kAccent2, fontFamily: 'monospace', fontSize: 12))),
            ]),
          ),
        ),
        Padding(
